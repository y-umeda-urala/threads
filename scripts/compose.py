...
SLOTS = [
    ...
    (14, "宿の紹介（楽天トラベル・PR）", "F（紹介型）", "お昼過ぎ。福井に泊まる人へ、条件で宿を比べて見せる枠。毎日1本"),
...
def build_prompt(board: str, neta: str, articles: str, works: str, recent: str, target_date, needed, filled, hotel=None, hotel_hour=None) -> str:
    slot_lines = "\n".join(
